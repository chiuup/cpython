...
echo.  --include-tkinter  Attempt to build Tkinter
echo.
...
if "%~1"=="--include-tkinter" (set IncludeTkinter=true) & shift & goto CheckOpts

if "%IncludeExternals%"=="" set IncludeExternals=true
if "%IncludeSSL%"=="" set IncludeSSL=true
if "%IncludeTkinter%"=="" set IncludeTkinter=false
...
@echo off
if "%target%"=="Build" (goto BuildEmbeddable)
if "%target%"=="Rebuild" (goto BuildEmbeddable)
